// week14_15_minesweep_part4_show_many_zeros_and_not_9_for_ii_for_jj
// 修改自 week14_14_minesweep_part3_click_mousePressed_show_one_number
// 畫出格子了, 但是第一下希望是空格, 把其他的數字都顯示
int [][]show = new int[10][7]; // 一開始,都不秀
void setup(){
  size(280,400);
  for(int k=0; k<1; k++){ // 要放5個地雷
